...
// == Actual mod ==
module.exports = {
  title: "MSPFA: " + adventureDetails.name, 
  ...
  computed(api) {
    ...
    baseHtml = baseHtml.replaceAll(`class="mspfa"`, `class="${adventureCSSClass}"`)
    ...
    return {
      ...
      styles: [
        { body: mspfaCSS.replaceAll(".mspfa ", "." + adventureCSSClass + " ") },
        { body: adventureCSS },
      ],
      ...
      edit(archive) {
        ...
        archive.tweaks.modHomeRowItems.push({
          ...
          description: `A port of the MS Paint Fan Adventure "${adventureDetails.name}"`,
        });
